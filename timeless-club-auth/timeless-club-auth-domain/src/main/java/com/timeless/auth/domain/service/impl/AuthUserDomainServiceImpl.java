...
import com.timeless.auth.infra.basic.entity.AuthUserRole;
...
import com.timeless.auth.infra.basic.service.AuthUserRoleService;
...
public class AuthUserDomainServiceImpl implements AuthUserDomainService {
    ...
    public Boolean register(AuthUserBO authUserBO) {
        ...
        if (StringUtils.isBlank(authUser.getAvatar())) {
            authUser.setAvatar("http://xxxxxxx:9000/user/icon/微信图片_20231203153718(1).png");
        }
