package com.timeless.auth.application.controller;

import com.alibaba.fastjson.JSON;
import com.google.common.base.Preconditions;
import com.timeless.auth.application.convert.AuthRolePermissionDTOConverter;
...
public class RolePermissionController {
    ...
    public Result<Boolean> add(@RequestBody AuthRolePermissionDTO authRolePermissionDTO) {
        try {
            ...
            AuthRolePermissionBO rolePermissionBO =
                    AuthRolePermissionDTOConverter.INSTANCE.convertDTOToBO(authRolePermissionDTO);
