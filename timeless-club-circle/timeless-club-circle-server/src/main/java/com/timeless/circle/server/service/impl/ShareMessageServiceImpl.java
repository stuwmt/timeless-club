...
import com.timeless.circle.server.dao.ShareMessageMapper;
import com.timeless.circle.server.entity.po.ShareMessage;
import com.timeless.circle.server.rpc.UserRpc;
import com.timeless.circle.server.service.ShareMessageService;
import com.timeless.circle.server.util.LoginUtil;
import com.timeless.circle.server.websocket.ChickenSocket;
...
public class ShareMessageServiceImpl extends ServiceImpl<ShareMessageMapper, ShareMessage> implements ShareMessageService {
    ...
    public PageResult<ShareMessageVO> getMessages(GetShareMessageReq req) {
        ...
        if (CollectionUtils.isNotEmpty(records)) {
            ...
            LambdaUpdateWrapper<ShareMessage> update =
                    Wrappers.<ShareMessage>lambdaUpdate().set(ShareMessage::getIsRead, 1).in(ShareMessage::getId, ids);
            super.update(update);
        }
