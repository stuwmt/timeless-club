...
import com.timeless.circle.api.common.PageInfo;
...
import com.timeless.circle.server.service.ShareMomentService;
...
public class ShareMomentServiceImpl extends ServiceImpl<ShareMomentMapper, ShareMoment> implements ShareMomentService {
    ...
    public PageResult<ShareMomentVO> getMoments(GetShareMomentReq req) {
        ...
        List<String> userNameList =
                records.stream().map(ShareMoment::getCreatedBy).distinct().collect(Collectors.toList());
    ...
    public Boolean removeMoment(RemoveShareMomentReq req) {
        ...
        LambdaUpdateWrapper<ShareCommentReply> update =
                Wrappers.<ShareCommentReply>lambdaUpdate().eq(ShareCommentReply::getMomentId, req.getId());
