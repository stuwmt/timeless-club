package com.timeless.circle.server.controller;

import com.alibaba.fastjson.JSON;
import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.baomidou.mybatisplus.core.toolkit.Wrappers;
import com.google.common.base.Preconditions;
import com.timeless.circle.api.common.Result;
...
public class ShareCommentController {
    ...
    public Result<Boolean> save(@RequestBody SaveShareCommentReplyReq req) {
        try {
            ...
            Preconditions.checkArgument((Objects.nonNull(req.getContent()) || Objects.nonNull(req.getPicUrlList())),
                    "内容不能为空！");
