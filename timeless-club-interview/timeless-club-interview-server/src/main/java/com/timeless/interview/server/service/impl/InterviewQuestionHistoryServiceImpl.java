...
import com.timeless.interview.api.enums.IsDeletedFlagEnum;
import com.timeless.interview.api.vo.InterviewQuestionHistoryVO;
import com.timeless.interview.server.dao.InterviewQuestionHistoryDao;
import com.timeless.interview.server.entity.po.InterviewQuestionHistory;
import com.timeless.interview.server.service.InterviewQuestionHistoryService;
import com.timeless.interview.server.util.LoginUtil;
...
public class InterviewQuestionHistoryServiceImpl extends ServiceImpl<InterviewQuestionHistoryDao,
        InterviewQuestionHistory> implements InterviewQuestionHistoryService {

    @Override
    public List<InterviewQuestionHistoryVO> detail(Long id) {
        LambdaQueryWrapper<InterviewQuestionHistory> query =
                Wrappers.<InterviewQuestionHistory>lambdaQuery().eq(InterviewQuestionHistory::getInterviewId, id)
