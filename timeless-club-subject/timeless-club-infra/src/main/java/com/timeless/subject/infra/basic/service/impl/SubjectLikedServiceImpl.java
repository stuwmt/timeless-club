package com.timeless.subject.infra.basic.service.impl;
...
import com.timeless.subject.infra.basic.mapper.SubjectLikedDao;
...
public class SubjectLikedServiceImpl implements SubjectLikedService {
    ...
    public SubjectLiked queryByCondition(SubjectLiked subjectLiked) {
        ...
        LambdaQueryWrapper<SubjectLiked> queryWrapper = Wrappers.<SubjectLiked>lambdaQuery()
                ...
                .eq(Objects.nonNull(subjectLiked.getIsDeleted()), SubjectLiked::getIsDeleted,
                        subjectLiked.getIsDeleted());
